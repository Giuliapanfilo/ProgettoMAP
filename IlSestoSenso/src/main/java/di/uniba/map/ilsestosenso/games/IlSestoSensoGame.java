    ...
    public void init() throws Exception {
        ...
        Room entranceHall = new Room(0, "Atrio", "Sei nell atrio, all'ingresso c'è un tappeto." +
                ...
                "e un guinzaglio per cani nero.", "Ti trovi probabilmente in una specie di"
                        + "ingresso, dato che ci sono appendiabiti e cassettiera, ma non vedi nessuna porta.");
        Room livingRoom = new Room(1, "Soggiorno", "Sei nel soggiorno, al centro della" +
                ...
                "appesa al muro ci sono una tv e un quadro e a sinistra nella stanza c'è un ampia libreria.", "Le risate provenivano da qui."
        ...
        Room kitchen = new Room(2, "Cucina", "Sei in cucina, al centro c'è una grande isola " +
                ...
                "mentre a sinistra della stanza c'è un calendario appeso.", "Sei in cucina, sembra tutto normale."
                        + "Piano cottura, isola, credenza e altri mobili. Quello che ti colpisce e' il calendario, forse converebbe guardarlo meglio.");
        Room walkinCloset = new Room(3, "Cabina armadio", "Sei nella cabina armadio, di fronte ci sono " +
                "due armadi, una scarpiera con diverse paia di scarpe e a terra sotto la scarpiera si trova una forchetta.", "Ti trovi nella cabina armadio,"
                        + "ci sono un sacco di vestiti e scarpe anche femminili.. e' strano. C'e' anche qualcosa che non dovrebbe stare qui, una forchetta."
                        + "Sarebbe il caso di riportarla al suo posto?");
        walkinCloset.setLook("Vedi una strana fessura tra due mattonelle del battiscopa. Spostandola noti che c'e' una scatoletta.");
        Room bedRoom = new Room(4, "Camera da letto", "Sei nella camera da letto, sul muro a sinistra c'è un " +
                ...
                "sopra un pc e una poltrona.", "Ti sei appena svegliato dopo un incubo orribile. Sei nella tua camera, completamente sudato e tremante."
